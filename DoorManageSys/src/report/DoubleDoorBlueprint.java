...
public class DoubleDoorBlueprint extends PDFReport {
	...
	public DoubleDoorBlueprint (Order order) throws IOException {
		...
		coordinate.put("width", new XYCoordinate (349, 441));
		coordinate.put("height", new XYCoordinate (147, 307));
		coordinate.put("frameLeft", new XYCoordinate (214,441));
		coordinate.put("frameRight", new XYCoordinate (485, 441));
		coordinate.put("frameTop", new XYCoordinate (500, 409));
		coordinate.put("hingeSpaceTop", new XYCoordinate (190, 408));
		coordinate.put("hingeSpaceMid", new XYCoordinate (190, 352));
		coordinate.put("hingeSpaceBottom", new XYCoordinate (190, 263));
		coordinate.put("strikeHeight", new XYCoordinate (418, 253));
		coordinate.put("formattedDate", new XYCoordinate (306, 100));
		coordinate.put("customerName", new XYCoordinate (410, 70));
		...
		assignFileName ("DoubleDoorBlueprint.pdf");
		
		firstPage = PDImageXObject.createFromFile("DoubleDoor.PNG", getDoc());
